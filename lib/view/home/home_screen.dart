    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Yeni birikim ekleme özelliği yakında eklenecek!')));
        },
        backgroundColor: Theme.of(context).primaryColor,
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Hayallerinize bir adım daha yaklaşın', style: TextStyle(fontSize: 16, color: Colors.white.withOpacity(0.9))),
            ],
          ),
        );
      },
          ...
          children: [
            ...
            TextButton(
              onPressed: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Tüm birikimler sayfası yakında eklenecek!')));
              },
